...
module.exports = function(self) {
  ...
  */
  ...
  self.vars._commands = ['serverName'];

  self._createGetSetFn = function(command) {
    return function(arg, cb) {
      ...
      self._doRequest(command, arg, self._getServerActionCallback(cb, String));
    };
  };

  self.vars._commands.forEach(function(cmd) {
    self.vars[cmd] = self._createGetSetFn('vars.'+cmd);
  });
/*
