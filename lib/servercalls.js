...
module.exports = function(self) {
  ...
  */
  ...
  self.banList.add.name = function(soldierName) {
    return self.banList._genTimeoutFn('persona', soldierName); //docs say name, server says persona.
  };
  ...
  self.banList.remove.name = function(soldierName, cb) {
    self._doRequest('banList.remove', ['persona', soldierName], self._getServerActionCallback(cb)); //docs say name, server says persona.
  };
